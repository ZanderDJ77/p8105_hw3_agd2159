...
locations of each state every year of the survey. This “Spaghetti” Plot
has smoothed lines for all 50 states in the survey from the colleciton
range of 2002 - 2010. It contains 443 from the 3 columns of interest
from the cleaned BRFSS dataset.
...
below 15% at any point in this study. Looking at intra-state variation,
there does seem to be a slight decline in excellent health response from
2002 through 2010 across states, this may result from large-scale social
...
![](p8015_hw3_agd2159_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
